...
async function run() {
  try {
    ...
    // Make sure passenger has enough wallet balance to complete ticket checkout
    // Seeded balance is 200, plus 20 recharge = 220. Draining coins didn't cost wallet balance, so 220 is plenty!
